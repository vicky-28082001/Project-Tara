...
function populateTable() {
    ...
    users.forEach((user, index) => {
        ...
        row.innerHTML = `
            ...
            <td class="creation-date">${user.creationDate}</td>
...
function toggleEditForm() {
    ...
    document.getElementById('edit-creation-date').value = user.creationDate;
...
function toggleViewForm() {
    ...
    document.getElementById('view-creation-date').value = user.creationDate;
...
function printSelectedDetails() {
    ...
    const detailKeys = ['Type','Full Name','Creation Date','Company Name', 'Mobile No', 'Email ID', 'City', 'Status'];
